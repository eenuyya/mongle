      ...
      <div className="mx-auto max-w-lg">
        ...
        <div className="px-6 py-6 space-y-7">
          ...
          <Section title="제1조 (목적)">
            본 약관은 몽글(이하 &ldquo;서비스&rdquo;)이 제공하는 서비스의 이용 조건 및 절차, 이용자와 서비스 간의 권리·의무 및 책임 사항을 규정함을 목적으로 합니다.
          </Section>

          <Section title="제2조 (정의)">
            <ol className="list-decimal list-inside space-y-1">
              <li>&ldquo;서비스&rdquo;란 몽글이 운영하는 웹 서비스 및 관련 제반 서비스를 의미합니다.</li>
              <li>&ldquo;이용자&rdquo;란 본 약관에 동의하고 서비스를 이용하는 자를 의미합니다.</li>
              <li>&ldquo;콘텐츠&rdquo;란 서비스 내에 게시된 장소 정보, 코스, 이미지 등 일체의 정보를 의미합니다.</li>
            </ol>
          </Section>
